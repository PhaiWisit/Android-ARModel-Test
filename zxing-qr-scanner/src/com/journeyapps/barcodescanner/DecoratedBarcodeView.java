...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        imageView.setBackgroundResource(R.drawable.nstda_logo);

        imageView2 = findViewById(R.id.zxing_imageview2);
        imageView2.setBackgroundResource(R.drawable.amed_logo);

        linearLayout = findViewById(R.id.zxing_linear);
